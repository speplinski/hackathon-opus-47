...
* text:      ``…_cluster01_<modelshort>.{jsonl,native.jsonl,provenance.json}``
* multimodal: ``…_cluster01_<modelshort>_multimodal.{jsonl,…}``
...
def main(argv: list[str] | None = None) -> int:
    ...
    native_stem = f"l4_verdicts_audit_accessibility_cluster01{suffix}"
